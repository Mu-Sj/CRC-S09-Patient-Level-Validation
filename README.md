...
The release documents a patient- and donor-level evaluation of colorectal cancer epithelial expression-state programs, a trajectory-execution audit, and separate descriptive progression analyses across public single-cell cohorts. Patients or donors are the inferential units; cells are used for coverage and quality-control accounting and are not treated as independent biological replicates.
